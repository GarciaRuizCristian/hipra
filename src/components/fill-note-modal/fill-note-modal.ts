...
@Component({
    selector: 'fill-note-modal',
    templateUrl: 'fill-note-modal.html',
})
export class FillNoteModal {
    ...
    constructor(
        ...
        this.form = new FormGroup({
            noteTitle: new FormControl({ value: '' }, Validators.compose([Validators.required])),
    ...
    saveNote() {
        if (this.isFormValid())
            this.viewCtrl.dismiss({ title: this.noteTitle, content: this.noteContent, type: this.noteTypeId });
        else {
